...
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree(String formno) {
        ...
        add(r3);
         ...
         r4=new JRadioButton("Rec Account");
        ...
        add(card);
         ...
         JLabel number=new JLabel("XXXX-XXXX-XXXX-4025");
        ...
        c1.setBounds(100,500,200,18);
         add(c1);
        
        c2=new JCheckBox("Internet Banking");
       c2.setBackground(Color.WHITE);
        c2.setFont(new Font("Raleway",Font.BOLD,15));
        c2.setBounds(350,500,200,18);
         add(c2);
        
        c3=new JCheckBox("Mobile Banking");
        c3.setBackground(Color.WHITE);
        c3.setFont(new Font("Raleway",Font.BOLD,15));
        c3.setBounds(100,550,200,18);
         add(c3);
        
        c4=new JCheckBox("Email & SMS Alerts");
        c4.setBackground(Color.WHITE);
        c4.setFont(new Font("Raleway",Font.BOLD,15));
        c4.setBounds(350,550,200,18);
         add(c4);
        
        c5=new JCheckBox("Cheque Book");
        c5.setBackground(Color.WHITE);
        c5.setFont(new Font("Raleway",Font.BOLD,15));
        c5.setBounds(100,600,200,18);
         add(c5);
         
        c6=new JCheckBox("E-Statement");
        c6.setBackground(Color.WHITE);
        c6.setFont(new Font("Raleway",Font.BOLD,15));
        c6.setBounds(350,600,200,18);
         add(c6); 
         
         c7=new JCheckBox("I hereby declare that the above entered details ate correct to the best of my knowledge");
